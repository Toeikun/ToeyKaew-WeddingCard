...
export default function RSVP() {
  return (
    <section id="rsvp" className="py-10 px-4 bg-white">
      <div className="flex justify-center items-center bg-white">
        <div className="max-w-6xl w-full flex flex-col lg:flex-row bg-white rounded-3xl shadow-lg overflow-hidden">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="w-full lg:w-1/2 p-8 md:p-12 flex flex-col justify-center items-center text-center"
          >
            ...
            <p className="text-sm md:text-base text-gray-500 mb-8 max-w-sm leading-relaxed">
              เพื่อให้เราได้จัดเตรียมงานล่วงหน้าได้อย่างเหมาะสม <br />
              ขอรบกวนทำแบบตอบรับการเข้าร่วมงานให้เราด้วยนะคะ
            </p>
            ...
            >
              ...
              {/* หรือ <EnvelopeIcon /> จาก Heroicons */}
              <span className="text-sm md:text-base font-semibold">
                RSVP : ตอบรับเข้าร่วมงาน
              </span>
            </a>
          </motion.div>
          ...
          >
            <div className="relative h-96 lg:h-full w-full">
              ...
              <div
                ...
                style={{ backgroundImage: "url('./images/IMTL221.webp')" }}
              >
              ...
              <img
                src="./images/IMTL221.webp" // แทนที่ด้วย path รูปภาพของคุณ
                alt="Couple"
